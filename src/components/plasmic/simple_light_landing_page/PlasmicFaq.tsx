...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: TdWNcHlzDIFUxk/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__lo7Ft)}
      >
        <div className={classNames(defaultcss.all, sty.box__qEfWb)}>
          <div className={classNames(defaultcss.all, sty.box___4Hzh)}>
            {p.renderPlasmicSlot({
