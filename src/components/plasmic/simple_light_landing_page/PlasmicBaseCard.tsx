...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: jv8TC2W99JhURE/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__nnEs3, {
          [sty.box__long__nnEs3B8045]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__aOgq4, {
            [sty.box__long__aOgq4B8045]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__okwL)}
                role={"img"}
              />
            ),
