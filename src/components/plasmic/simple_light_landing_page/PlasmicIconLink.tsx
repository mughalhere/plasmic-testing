...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: 8S692KjJTIm_5/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__cPDcB)}
              role={"img"}
            />
          ),
