...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: -6lu5GlkuIthA4/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: IliJGIT7iX3H-O/icon
import profilepicCwUyhr6Kn9VHPz from "./images/profilepic.png"; // plasmic-import: CWUyhr6Kn9vHPz/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__bjrHo)}
      >
        <div
